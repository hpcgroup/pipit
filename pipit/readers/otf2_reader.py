        ...
        with otf2.reader.open(self.dir_name) as trace:
            ...
            for loc_event in loc_events:
                ...
                if eventType != "Leave":
                    ...
                    eventAttributes.append(float("NaN")) #no need for duplicate attributes

            trace.close() #close event files

        #returns dictionary with all events and their fields
        return {"Event": eventTypes, "Timestamp (ns)": timestamps, "Name": names, "Location ID": locs, "Location Type": locTypes,
